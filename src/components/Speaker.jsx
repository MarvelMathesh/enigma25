...
function Speaker({ values = {}, name, subname, ct = "", image, index }) {
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center w-full px-6 md:px-12 lg:px-20 py-10 gap-6 md:gap-12 lg:gap-16 bg-black text-yellow-500 border border-green-500 shadow-md rounded-lg transition-transform duration-300 hover:scale-[1.02]">
      ...
      <div ref={containerRef} className="w-full lg:w-2/3 text-white">
